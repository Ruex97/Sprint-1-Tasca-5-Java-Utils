...
public class App {
	...
	public static void main(String[] args) {
		if (args.length < 1) {
			System.out.println("Usage: java NameOfTheFile ARGUMENT(txt)");
		} else {
			TxtReader(args[0]);
		}
	...
	static void TxtReader(String path) {
		
		try {
			BufferedReader myBuffer = new BufferedReader(new FileReader(path));
			String line;
